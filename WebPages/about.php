...
<html>
  ...
  <body>
	...
	<div class="table" text-align="center">
		<ul style="list-style:none;display:inline" align="center">
			<li><img src="kevin.jpg" style="float:left;width:120px;height:120px;padding-right:15px;padding-left:285px"></li>
	...
	<br><br><br><br><br>
	<p style="padding-left:285px;padding-right:265px"> From left to right: Kevin Kleinschmidt (Project Manager), Nicole Padrazo (IT System Administrator), Nick Klacik (Software Developer), Brandon Litwin (Software Developer), Ian Sniffen (Software Developer), Prof. Pablo Rivas (Faculty Advisor).</p>
	</body>
</html>
